...
$data = getCURL(_url . "/api-search/get-event-match-search?searchValue=" . $_GET['searchValue']);
                            ...
                            <div class="col-md-12">
                                ...
                                if (count($data) > 0) {
                                    foreach ($data as $value) {
                                        echo "<a style='text-decoration: none;' href='event.php?event_id=" . $value['id'] . "&r=" . getRandomNumber() . "'>";
                                        ?>
                                            <div class="rca-match-start" style="margin-bottom: 15px;
                                                ...
                                                <div class="rca-padding">
                                                    <h2><?= $value['match_title'] ?></h2>                  
                                                    <p class="rca-center">
                                                        <?php
                                                        echo "<a href='event.php?event_id=" . $value['id'] . "&r=" . getRandomNumber() . "'>{$value['series']}</a>";
                                                        ?>
                                                    </p>
                                                </div>
                                            </div>
