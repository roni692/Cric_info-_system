            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <section id="cricket" style="padding:  35px 5px; ">
                        ...
                        <p class="small"><i>Courtesy: https://cricbuzz.com/history.htm
...
.com</i></p>
                    ...
                    <section id="thePlayer" style="padding:  35px 5px; ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="images/cricket_bat.gif"  class="img-responsive"alt="" />                        <p class="small"><i>Courtesy: https://cricbuzz.com/history.htm</i></p>
                    ...
                    <section id="pitch" style="padding:  35px 5px; ">
                        ...
                        <img src="images/Cricket_pitch.svg" alt="" class="img-responsive" />
                                                <p class="small"><i>Courtesy: https://cricbuzz.com/pitchinfo.htm</i></p>
                    ...
                    <section id="cricketField" style="padding:  35px 5px; ">

                        <h3>
                            Cricket Field
                        </h3>
                        <p>
                            A <b>cricket field</b> is a large grassy ground on which the game of cricket is played. Although generally oval in shape, there is a wide variety within this: some are almost perfect circles, some elongated ovals and some entirely irregular shapes with little or no symmetry – but they will have entirely curved boundaries, almost without exception. There are no fixed dimensions for the field but its diameter usually varies between 450 feet (137 m) and 500 feet (150 m).
                        </p>
                        <img src="images/436px-Cricket_field_parts.svg.png" alt="" class="img-responsive center-block" />
                                                <p class="small"><i>Courtesy: https://cricbuzz.com/ground.htm</i></p>

                    </section>
                    <div class="clearfix"></div>

                    <section id="originCricket" style="padding:  35px 5px; ">
                        <h3>Origin of cricket:</h3>
                    ...
                    <section id="evolutionBat" style="padding:  35px 5px; ">
                    ...
                    <section id="internationalSport" style="padding:  35px 5px; ">
                        ...
                        <div class="col-md-4">
                            <img src="images/England_in_North_America_1859.jpg" class="img-responsive" alt="" />
                                                    <p class="small"><i>Courtesy: https://cricbuzz.com/history.htm</i></p>
                    ...
                    <section id="basicGamePlay" style="padding:  35px 5px; ">
                        ...
                        <img src="images/basic_gameplay.jpg" class="img-responsive center-block" alt="" />
                                                <p class="small"><i>Courtesy: https://cricbuzz.com/rulesinfo.htm</i></p>
                    ...
                    <section id="governance" style="padding:  35px 5px; ">
                        ...
                        <img src="images/governance.jpg" class="img-responsive center-block" alt="" />
                                                <p class="small"><i>Courtesy: https://cricbuzz.com/governance.htm</i></p>
                ...
                <div class="col-md-3">
                    <div style="position: fixed;top:100px;">
                        <ul>
                            ...
                            <li><a href="#cricketField">Cricket Field</a></li>
