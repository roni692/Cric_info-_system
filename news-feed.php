                ...
                <div class="rca-column-12">
                    <div class="rca-mini-widget rca-tab-simple">
                        <ul class="rca-tab-list">
                            ...
                            <li class="rca-tab-link active" data-tab="rtab-2" onclick="showTab(this);">Videos</li>
                        </ul>
...
//                                                } else {
                                                    ?>
                                                    <img src="<?= _HOST . "image_not_available.png" ?>" class="img-responsive pull-right" alt="" />
                                                    <?php
//                                                }
                                                ?>
                                            <div class="rca-blog-head">
                        ...
                        <div id="rtab-2" class="rca-padding rca-tab-content active">
                            <?php
