...
<html lang="en">
    ...
    <body>
        ...
        <div class="rca-container">
            ...
            <!--world cup images-->
            <div class="row">
                <div class="rca-column-1"></div>
                <div class="rca-column-6">
                    <div class=" " style="    border-top: 5px solid #1eb848;background-color: #fff; margin: 15px 0;padding: 10px 10px">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="clearfix"></div>
                    <h3>Specialist roles <small><i>captain (cricket) and wicket-keeper</i></small></h3>
                ...
                <div class="col-md-3">
                    <ul style="position: fixed; top: 100px; right: 0; border: 0;">
